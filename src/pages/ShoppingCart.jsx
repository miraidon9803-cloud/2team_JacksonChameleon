...
const ShoppingCart = () => {
    const { cartItems, totalPrice, onRemoveCart, onItemPlus, onItemMinus, onCheckCart,
        getSelectedItems, getItemTotal, getSelectedTotalPrice, getItemSalePrice } = useProductStore();
                    ...
                    <div className="total-wrap">
                        <div className="total-content">
                            ...
                            <ul>
                                ...
                                <li><span>할인 금액</span><span>{getItemSalePrice().toLocaleString()}</span></li>
                            ...
                            <div className="total-price">
                                <span>총 구매 금액</span>
                                <strong>
                                    {(getSelectedTotalPrice() - getItemSalePrice()).toLocaleString()}원
                                </strong>
                            </div>
