    ...
    <main>
      <section className="main-video-wrap">
        ...
        <div className="main-title">
          ...
          <p>Round B chair complete with the silhouette itself <br />
            It has a high-quality silhouette in a simpler form by minimizing the processing range of wood.</p>
        </div>

        {isVisibleMainpopup && (
          <div className="main-popup">
            <p>다양한 커스텀이 가능한 잭슨파멜레온을 만나보세요
              <span onClick={handleClosePopup}><img src="./images/cancel.png" alt="" /></span>
            </p>
          </div>
        )}
      </section>
