    ...
    return (
        <section className="main-swiper-chair">
            ...
            <div className="img-box">
                <img className=' left animate__animated animate__fadeInBottomLeft' src="/images/main-best-chair-left.png" alt="제품이미지" />
                <img className='right animate__animated animate__fadeInTopRight' src=" /images/main-best-chair-right.png" alt="제품이미지" />
            </div>
        </section>
    )
}
