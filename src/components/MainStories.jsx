          ...
          >
            ...
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory1.png" alt="" /></div>
                <p>Colour Edition 2025</p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory2.png" alt="" /></div>
                <p>1인부터 4인까지</p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory3.png" alt="" /></div>
                <p>With White</p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory4.png" alt="" /></div>
                <p>Happy New Year's My House</p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory5.png" alt="" /></div>
                <p>Clay</p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory6.png" alt="" /></div>
                <p>불편함보다 편리함이 더 큰 미니멀 인테리어</p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory7.png" alt="" /></div>
                <p>하우스 오브 잭슨카멜레온</p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className='mainstory-cards'>
                <div><img src="/images/mainstory8.png" alt="" /></div>
                <p>블랙이 끌리는 이유</p>
              </div>
            </SwiperSlide>
